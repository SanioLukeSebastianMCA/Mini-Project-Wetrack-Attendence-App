...
public class SelectUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        select_radiogroup.setOnCheckedChangeListener((radioGroup, i) -> {
            ...
            Typeface light= ResourcesCompat.getFont(getApplicationContext(), R.font.poppins_light);
            Typeface semibold= ResourcesCompat.getFont(getApplicationContext(), R.font.poppins_semibold);
